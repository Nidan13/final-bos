...
var defaultRBACRoles = []models.RBACRole{
	...
	{Key: "kencana_admin", Label: "Admin Kencana Univ", Description: "Akses penuh modul Kencana Universitas", IsSystem: true, Status: "active", Permissions: mustJSON([]string{"kencana.dashboard.view", "kencana.announcement.view", "kencana.announcement.create", "kencana.announcement.update", "kencana.announcement.delete", "kencana.timeline.view", "kencana.timeline.create", "kencana.timeline.update", "kencana.timeline.delete", "kencana.timeline.sync_sevima", "kencana.pre_kencana.view", "kencana.pre_kencana.create", "kencana.pre_kencana.update", "kencana.pre_kencana.delete", "kencana.university.view", "kencana.university.create", "kencana.university.update", "kencana.university.delete", "kencana.faculty_stages.view", "kencana.faculty_stages.create", "kencana.faculty_stages.update", "kencana.faculty_stages.delete", "kencana.score_summary.view", "kencana.scores.view", "kencana.scores.create", "kencana.scores.update", "kencana.scores.delete", "kencana.banding.view", "kencana.banding.update", "kencana.remedials.view", "kencana.remedials.create", "kencana.remedials.update", "kencana.remedials.delete", "kencana.certificates.view", "kencana.certificates.create", "kencana.certificates.update", "kencana.certificates.delete", "kencana.certificates.generate", "kencana.participants.view", "kencana.participants.create", "kencana.participants.update", "kencana.participants.delete", "kencana.participants.sync_sevima", "kencana.participants.reset", "kencana.groups.view", "kencana.groups.create", "kencana.groups.update", "kencana.groups.delete", "kencana.mentors.view", "kencana.mentors.create", "kencana.mentors.update", "kencana.mentors.delete", "kencana.mentor.dashboard", "kencana.mentor.view", "kencana.mentor.update", "kencana.mentor.settings", "kencana.attendance.view", "kencana.attendance.update", "kencana.handbook.view", "kencana.handbook.update", "kencana.notifications.view", "kencana.settings.view", "kencana.settings.update", "kencana.faculty.dashboard", "kencana.faculty.sync_sevima"})},
	{Key: "kencana_fakultas", Label: "Admin Kencana Fakultas", Description: "Akses modul Kencana tingkat Fakultas", IsSystem: true, Status: "active", Permissions: mustJSON([]string{"kencana.dashboard.view", "kencana.faculty_stages.view", "kencana.faculty_stages.create", "kencana.faculty_stages.update", "kencana.faculty_stages.delete", "kencana.participants.view", "kencana.scores.view", "kencana.score_summary.view", "kencana.remedials.view", "kencana.certificates.view", "kencana.banding.view", "kencana.banding.update", "kencana.groups.view", "kencana.groups.create", "kencana.groups.update", "kencana.groups.delete", "kencana.mentors.view", "kencana.mentors.create", "kencana.mentors.update", "kencana.mentors.delete", "kencana.announcement.view", "kencana.announcement.create", "kencana.announcement.update", "kencana.announcement.delete", "kencana.faculty.dashboard", "kencana.faculty.sync_sevima"})},
	{Key: "kencana_mentor", Label: "Mentor Kencana", Description: "Akses Dewan Pembimbing / Mentor Kencana", IsSystem: true, Status: "active", Permissions: mustJSON([]string{"kencana.mentor.dashboard", "kencana.mentor.view", "kencana.mentor.update", "kencana.mentor.settings"})},
}
...
func determineRequiredProfiles(rolesStr string) (isPsikolog, isTenakes, isOrmawa, isFakultas, isMahasiswa bool) {
	...
	isFakultas = strings.Contains(roleLower, ",faculty_admin,") || strings.Contains(roleLower, ",prodi_admin,") || strings.Contains(roleLower, ",kencana_fakultas,") || isOrmawa
