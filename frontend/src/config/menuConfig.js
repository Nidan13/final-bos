...
export const MENU_ITEMS = [
    ...
    items: [
      {
        ...
        submenu: [
          ...
          { name: 'Pengaturan Akun', icon: 'settings', path: '/app/profile'},
        ],
      }
    ],
  },
    ...
    items: [
      {
        ...
        submenu: [
          ...
          { name: 'Monitoring Fakultas', icon: 'monitoring', path: '/app/kencana/faculty-monitoring', permission: P.KENCANA_UNIV_VIEW },
          { name: 'Notifikasi', icon: 'notifications', path: '/app/kencana/notifications', permission: P.KENCANA_DASHBOARD_VIEW },
          { name: 'Pengaturan Akun', icon: 'settings', path: '/app/profile', permission: P.KENCANA_SETTINGS_VIEW },
        ],
      },
      {
        ...
        submenu: [
          ...
          { name: 'Pengaturan Sertifikat', icon: 'settings_applications', path: '/app/kencana/certificate-settings', permission: P.KENCANA_CERTIFICATE_VIEW },
        ],
      },
      {
        name: 'Portal Fakultas',
        icon: 'corporate_fare',
        path: '/app/kencana/faculty',
        hasSubmenu: true,
        permission: P.KENCANA_FACULTY_VIEW,
        submenu: [
          { name: 'Dashboard Fakultas', icon: 'dashboard', path: '/app/kencana/faculty/dashboard', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Pengumuman', icon: 'campaign', path: '/app/kencana/faculty/announcements', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Jadwal & Tahap', icon: 'event', path: '/app/kencana/faculty-stages', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Peserta Fakultas', icon: 'groups', path: '/app/kencana/faculty/participants', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Kelola Kelompok', icon: 'group_work', path: '/app/kencana/faculty/groups', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Kelola Mentor', icon: 'supervisor_account', path: '/app/kencana/faculty/mentors', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Nilai Fakultas', icon: 'grade', path: '/app/kencana/faculty/scores', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Banding Nilai', icon: 'gavel', path: '/app/kencana/faculty/banding', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Rekap Nilai Kelompok', icon: 'assessment', path: '/app/kencana/faculty/score-summary', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Remedial', icon: 'autorenew', path: '/app/kencana/faculty/remedials', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Sertifikat', icon: 'workspace_premium', path: '/app/kencana/faculty/certificates', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Notifikasi', icon: 'notifications', path: '/app/kencana/faculty/notifications', permission: P.KENCANA_FACULTY_VIEW },
          { name: 'Pengaturan Akun', icon: 'settings', path: '/app/profile', permission: P.KENCANA_FACULTY_VIEW },
        ],
      },
    ],
  },
  ...
  // =============================================
  {
    group: 'DEWAN PEMBIMBING',
    module: 'kencana_mentor',
    items: [
      { name: 'Dashboard DP', icon: 'dashboard', path: '/app/kencana/mentor', permission: P.KENCANA_MENTOR_DASHBOARD },
      ...
      { name: 'Manajemen Anak Didik', icon: 'groups', path: '/app/kencana/mentor/students', permission: P.KENCANA_MENTOR_STUDENTS },
      { name: 'Persetujuan Handbook', icon: 'menu_book', path: '/app/kencana/mentor/handbook', permission: P.KENCANA_MENTOR_STUDENTS },
      { name: 'Validasi Kehadiran', icon: 'fact_check', path: '/app/kencana/mentor/attendance', permission: P.KENCANA_MENTOR_STUDENTS },
      { name: 'Catatan Bimbingan', icon: 'edit_note', path: '/app/kencana/mentor/notes', permission: P.KENCANA_MENTOR_STUDENTS },
      { name: 'Penilaian Akhir (Skoring)', icon: 'grade', path: '/app/kencana/mentor/scoring', permission: P.KENCANA_MENTOR_STUDENTS },
      { name: 'Pengaturan Akun', icon: 'settings', path: '/app/profile', permission: P.KENCANA_MENTOR_SETTINGS },
      { name: 'Notifikasi', icon: 'notifications', path: '/app/kencana/mentor/notifications', permission: P.KENCANA_MENTOR_STUDENTS },
    ],
  },
