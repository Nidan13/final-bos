...
export const MENU_ITEMS = [
    ...
    items: [
      ...
      },
      {
        ...
        submenu: [
          ...
          { name: 'Pengaturan Fakultas', icon: 'settings', path: '/app/kencana/faculty/settings', permission: P.KENCANA_FACULTY_VIEW },
        ],
      },
    ],
  },
  ...
  // =============================================
  {
    ...
    items: [
      ...
      { name: 'Pengaturan Akun', icon: 'settings', path: '/app/kencana/mentor/settings', permission: P.KENCANA_MENTOR_SETTINGS },
