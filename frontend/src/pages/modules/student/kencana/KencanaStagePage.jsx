...
export default function KencanaStagePage() {
  ...
  if (stageId === '0' || stageId === 0) {
    return <KencanaShell title="Detail Tahap" breadcrumbs={[{ label: 'Dashboard', to: '/app/student/kencana' }, { label: 'Detail Tahap' }]}><ErrorPanel message="Tahap tidak ditemukan atau belum dibuka." /></KencanaShell>;
  }
